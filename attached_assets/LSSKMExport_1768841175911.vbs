...
Do Until AlohaINI.AtEndofStream
  ...
  Select Case Left(str, Instr(str, "="))
    Case "UNITNUMBER="
       strStore = Mid(str, Instr(str, "=")+3, Len(str))
  End Select
Loop
AlohaINI.close
...
If Return = 0 Then
  oShell.Run sysDrive & ":\Progra~1\NCRBackOffice\BackOfficeSwitchboard\BackOfficeSwitchboard.exe /User autoPOS /Password otto /SiteID BKTH40" & strStore & " /ExportID LSS", 7, TRUE
End If
