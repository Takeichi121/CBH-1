...
> *โปรดแนบไฟล์ภาพหน้าจอไว้ที่ `client/src/assets/` และเปลี่ยนชื่อไฟล์ในจุดนี้เมื่อมีภาพจริง*

![ตัวอย่าง Dashboard](./assets/ui-sample-1.png)
![ตัวอย่างจัดการกะ](./assets/ui-sample-2.png)
![จอ Export รายงาน](./assets/ui-sample-3.png)
