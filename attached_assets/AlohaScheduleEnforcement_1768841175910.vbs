...
If Return = 0 Then
  oShell.Run sysDrive & ":\Progra~1\NCRBackOffice\BackOfficeSwitchboard\BackOfficeSwitchboard.exe /User autoPOS /Password otto /SiteID BKTH" & strStore & " /ExportID SCHEMP", 7, TRUE
End If
